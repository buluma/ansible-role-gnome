...
When you spot an issue, [create an issue](https://github.com/buluma/ansible-role-gnome/issues).

Making the issue help me and others to find similar problems in the future.

### [2. Fork the project.](#2-fork-the-project)

On the top right side of [the repository on GitHub](https://github.com/buluma/ansible-role-gnome), click `fork`. This copies everything to your GitHub namespace.
